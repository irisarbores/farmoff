...
const THEME = {
  ...
  accent: '#F59E0B' // 注意を引くアクセントカラー（オレンジ系）
};
      ...
      <section style={{ padding: '60px 20px', maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <FaqItem 
            ...
            answer="A. 当社が提供するテンプレートに沿って、管理委託用のマニュアルを作成していただきます。基本的には合計で1時間程度の作業を上限としております。代行以外の農作業（基本的なサービスの範囲を超えた草むしりなど）は、追加料金をいただきます。" 
          />
        </div>
      </section>
...
function Arrow() {
  return (
    <div style={{ textAlign: 'center', color: THEME.primary, fontSize: 24 }}>
      ↓
    </div>
  );
}
